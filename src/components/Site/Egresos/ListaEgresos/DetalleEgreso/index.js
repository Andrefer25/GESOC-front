...
const DetalleEgreso = ({ data, onHide, visible }) => {
    const renderFooter = (
        <div>
    ...
    return (
        <Dialog header={`Detalle del Egreso ${data.idEgreso}`} visible={visible} style={{ width: '50vw' }} footer={renderFooter} onHide={() => onHide()}>
            <Form>
                <Row form>
                    <Col md={6}>
                    <FormGroup>
