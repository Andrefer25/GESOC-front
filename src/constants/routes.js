...
export const categoriaUrl = port+"/gesoc/categorias";
...
export const validadorUrl = port+"/gesoc/ValidadorTransparencia";
export const criterioVinculadorUrl = port+"/gesoc/criteriosVinculacion";
export const validarUrl = port+"/gesoc/vincularOperaciones";
